...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c112 = function(start, parts) { return start + parts.join(''); },
      peg$c113 = /^[A-Za-z_]/,
  ...
  function peg$parsecolumn_nameY() {
    var s0, s1, s2, s3;
